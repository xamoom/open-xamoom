...
public class MainActivity extends AppCompatActivity implements XamoomContentFragment.OnXamoomContentFragmentInteractionListener {
    ...
    private static final String TESTING_CONTENT_ID = "your-content-id-here";
    private static final String TESTING_MARKER_ID = "5k9kv";
    private static final String[] TESTING_BEACON = new String[]{"your-beacon-uuid-here","your-beacon-major-here","your-beacon-minor-here"};
