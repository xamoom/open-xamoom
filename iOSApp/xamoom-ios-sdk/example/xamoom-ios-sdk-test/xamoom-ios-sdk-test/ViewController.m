...
NSString * const kContentId = @"your-content-id-here";
NSString * const kLocationIdentifier = @"your-location-identifier-here";
...
- (void)viewDidLoad {
  ...
  [[XMMEnduserApi sharedInstance] setApiKey:@"your-api-key-here"];
}
